  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="container mx-auto section flex-grow">
        <section id="profile" className="flex max-w-4xl mx-auto bg-base-300 rounded-xl shadow-lg p-3 min-h-[600px] min-w-[800px]">
          <div className="w-1/2 p-4 mr-4">
            <div className="flex items-center justify-center border-b border-neutral">
              <h2><FaUser className="text-4xl mr-4" /></h2>
              <h2 className="text-[34px] font-bold text-center border-neutral mt-14">USER PROFILE</h2>
            </div>
          ...
          <div className="w-1/2 p-4">
            <div className="flex items-center justify-center border-b border-neutral">
              <h2><FaPaw className="text-4xl mr-4" /></h2>
              <h2 className="text-[34px] font-bold text-center border-neutral mt-14">FAVORITE PETS</h2>
            </div>
                ...
                <div key={pet._id} className="rounded-lg p-3 hover:border hover:shadow-md">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      />
                      <div>
                        <Link to={`/pets/${pet._id}`} className="text-neutral text-[21px] no-underline hover:opacity-75"><h4 className='mb-0 font-bold'>{pet.name}</h4></Link>
                        <p className='text-neutral text-[14px] mt-0 mb-0 italic'>{pet.breed || pet.species}</p> 
                        <p className='text-neutral text-[14px] mt-0'>{pet.location}</p> 
                      </div>
                    </div>
