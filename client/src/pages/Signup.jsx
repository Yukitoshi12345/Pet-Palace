      ...
      <div className="container px-4 mt-20 relative">
        ...
        <div className="flex flex-col items-center lg:items-stretch lg:justify-start z-10 lg:flex-row">
          <div className="max-w-md w-full ">
            <div className="bg-neutral shadow-md  px-8 py-8 border-r-2 rounded-t-3xl lg:rounded-t-none lg:rounded-l-3xl">
          ...
          <div className='max-w-md w-full px-6 bg-neutral text-base-100 lg:min-w-max'>
            <h3>Get instantly access to our services by joining us today!</h3>
            <ul className=''>
              <li> Get access to all our exclusive contents</li>
              <li>Save the pets you like to your favourite list</li>
              <li>You can opt in to our quarterly newsletter</li>
              <li>You can make a booking to visit our shelters</li>
              <li>When you donate, we send you free gift pack</li>
            </ul>
          </div>
