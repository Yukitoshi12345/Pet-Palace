    ...
    <main className=" section">
      <div className="container px-4 mt-20 relative">
        <div className="absolute -right-24 -top-28 hidden lg:block">
              <img src={pet} alt="sad dog" className="mask mask-heart max-h-[800px] opacity-45 -z-30" />
        </div>
        <div className="flex flex-col items-center lg:items-stretch lg:justify-start z-10 lg:flex-row">
          ...
          <div className='max-w-md w-full px-6 bg-neutral text-base-100 lg:min-w-max'>
            ...
            <ul className=''>
              <li className='flex gap-4 items-center'><FaUnlockAlt/> Get access to all our exclusive contents</li>
              <li className='flex gap-4 items-center'><FaSave/>Save the pets you like to your favourite list</li>
              <li className='flex gap-4 items-center'><FaNewspaper/>You can opt in to our quarterly newsletter</li>
              <li className='flex gap-4 items-center'><FaCalendarDay/>You can make a booking to visit our shelters</li>
              <li className='flex gap-4 items-center'><BiSolidDonateHeart/>When you donate, we send you a free gift pack</li>
            </ul>
          </div>
